...
<div class="container">
    <div id="area_all_tasks">
        <div id="area_tasks_parent">
            <div class="tasks-header">親タスク</div>
        ...
        <div id="area_tasks_child">
            <div class="tasks-header">子タスク</div>
    ...
    <div id="area_comment">
        <div class="row-comment">
            ...
            <textarea name="comment" class="comment" onchange="updateComment(this)" palaceholder="コメント"></textarea>
        </div>
    </div>
</div>
</main>
